	...
	<div class="container">
		<div class="row">
			...
			<div class="col-md-6 col-lg-3 ftco-animate">
				<div class="product">
					<a href="{{url('product_details',$products->id)}}" class="img-prod"><img class="img-fluid" src="products/{{$products->image}}" alt="Colorlib Template">
						<span class="status">
					...
					<div class="text py-3 pb-4 px-3 text-center">
						...
						<div class="d-flex">
							<div class="pricing">
								<p class="price"><span class="mr-2 price-dc">{{ number_format($products->price, 0, ',', '.') }} VND</span><br><span class="price-sale">{{ number_format($products->discount_price, 0, ',', '.') }} VND</span></p>
							</div>
						</div>

...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/profile/user-order/details/{order_id}', [ProfileController::class, 'userOrdersDetails'])->name('profile.userEditDetails');
...
Route::group(["prefix" => "admin"], function () {
    ...
    Route::get('/users/delete/{id}', [AdminController::class, 'deleteUser'])->name('delete_user'); // Delete a user
    ...
    //gallery
    Route::get('/gallery', [AdminController::class, 'listGallery'])->name('gallery.index');
    Route::get('/gallery/add', [AdminController::class, 'addToGallery'])->name('gallery.add');
    Route::post('/gallery/store', [AdminController::class, 'storeGallery'])->name('gallery.store');
    Route::delete('/gallery/delete/{id}', [AdminController::class, 'deleteGallery'])->name('gallery.deletePhoto');
});
